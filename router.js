...
let router = require('koa-router'),
	...
	viewsRouter.post('/test',function*(){
		const paypal = Paypal.init('contratos_api1.behealthbrasil.com.br', 'HANLTNBQUS73LC7Y', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AmXHhTEQfagUjb8J7fLR3E1Hc-qF', 'https://behealthbrasil.com.br/confirmation', 'https://behealthbrasil.com.br/error');
		
		var pay = paypal.pay('20130001', 123.23, 'iPad', 'BRL', true, function(err, url) {
	if (err) {
		console.log(err);
		return;
	}
